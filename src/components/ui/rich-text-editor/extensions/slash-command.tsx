...
import { openContextModal } from '../../modal/events';
...
const getSuggestionItems = ({ query }: { query: string }) => {
  return [
    ...
    // },
    {
      ...
      description: 'Faites-nous savoir comment nous pouvons nous améliorer.',
    ...
    >
      {items.map((item: CommandItemProps, index: number) => {
        return (
          ...
          >
            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md border border-stone-200 bg-white">
