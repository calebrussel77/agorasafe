...
>(({ className, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(
        'group pointer-events-auto relative my-3 flex w-full items-start overflow-hidden rounded-md border p-4 pr-6 shadow-lg',
        ...
        'border bg-background text-gray-800',
        className
      )}
      {...props}
    />
...
>(({ className, size = 'xs', variant, ...props }, ref) => (
...
const ToastIcon = React.forwardRef<
  React.ElementRef<typeof VariantIcon>,
  React.ComponentPropsWithoutRef<typeof VariantIcon>
