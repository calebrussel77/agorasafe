...
//           </h2>
//           <p className="mt-6 text-lg tracking-tight text-brand-100">
...
//                             selectedIndex === featureIndex
//                               ? 'text-brand-600 lg:text-white'
//                               : 'text-brand-100 hover:text-white lg:text-white'
//                           )}
//                         >
...
//                       </p>
//                     </div>
//                     <div className="mt-10 w-[45rem] overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-brand-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
//                       <Image
//                         className="w-full"
//                         src={feature.image}
//                         alt=""
