...
export function PrimaryFeatures({ type }: { type: 'customer' | 'provider' }) {
  return (
    <section
      id="features"
            ...
            <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:items-center lg:gap-8">
              <div className="lg:col-start-2">
                ...
                <p className="mt-3 text-lg text-gray-500">
                  ...
                  compétences. Faites grandir vos finances en offrant vos
                  services et en atteignant de nouveaux sommets de réussite.
                </p>
                  ...
                  {providerFeatures.map(item => (
                    <div key={item.id} className="relative">
                      <dt>
                        <div
                          className={cn(
                            'absolute flex h-12 w-12 items-center justify-center rounded-xl bg-brand-600 text-white'
                          )}
                        >
        ...
        {type === 'customer' && (
          <div className="relative mt-12 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
            <div className="relative">
              ...
              <p className="mt-3 text-lg text-gray-500">
                Trouvez des prestataires locaux qualifiés pour répondre à tous
                vos besoins, qu'il s'agisse de petits travaux, de services du
              ...
              <dl className="mt-10 space-y-10">
                {customerFeatures.map(item => (
                  <div key={item.id} className="relative">
                    <dt>
                      <div className="absolute flex h-12 w-12 items-center justify-center rounded-xl bg-pink-600 text-white">
                        <item.icon className="h-8 w-8" aria-hidden="true" />
                      </div>
                      <p className="ml-16 text-lg font-medium leading-6 text-gray-900">
                        {item.name}
